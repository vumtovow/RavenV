...
import ravenv.command.CommandManager;
import ravenv.command.commands.*;
import ravenv.config.Config;
import ravenv.event.EventManager;
import ravenv.management.*;
import ravenv.module.Module;
import ravenv.module.ModuleManager;
import ravenv.module.modules.*;
import ravenv.property.Property;
import ravenv.property.PropertyManager;
...
public class RavenV {
    ...
    public void init() {
        ...
        try (InputStreamReader reader = new InputStreamReader(Objects.requireNonNull(RavenV.class.getResourceAsStream("/mcmod.info")), StandardCharsets.UTF_8)) {
