...
public class CommandManager {
    ...
    public void handleCommand(String string) {
        ...
        if (params.get(0).isEmpty()) {
            ChatUtil.sendFormatted(String.format("%sUnknown command&r", RavenV.clientName).replace("&", "§"));
        } else {
            ...
            ChatUtil.sendFormatted(String.format("%sUnknown command (&o%s&r)&r", RavenV.clientName, params.get(0)).replace("&", "§"));
        }
    }
