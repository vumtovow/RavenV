...
import ravenv.management.RotationState;
import ravenv.mixin.IAccessorPlayerControllerMP;
...
public class KillAura extends Module {
    ...
    private boolean performAttack(float yaw, float pitch) {
        if (!RavenV.playerStateManager.digging && !RavenV.playerStateManager.placing) {
    ...
    private boolean canAttack() {
        if (this.inventoryCheck.getValue() && mc.currentScreen instanceof GuiContainer) {
            ...
            if (((IAccessorPlayerControllerMP) mc.playerController).getIsHittingBlock()) {
                ...
                AutoHeal autoHeal = (AutoHeal) RavenV.moduleManager.modules.get(AutoHeal.class);
                if (autoHeal.isEnabled() && autoHeal.isSwitching()) {
                    return false;
                } else {
                    BedNuker bedNuker = (BedNuker) RavenV.moduleManager.modules.get(BedNuker.class);
                    if (bedNuker.isEnabled() && bedNuker.isReady()) {
                        return false;
                    } else if (RavenV.moduleManager.modules.get(Scaffold.class).isEnabled()) {
                        return false;
    ...
    public boolean isAttackAllowed() {
        Scaffold scaffold = (Scaffold) RavenV.moduleManager.modules.get(Scaffold.class);
    ...
    public void onUpdate(UpdateEvent event) {
        if (event.getType() == EventType.POST && this.blinkReset) {
            ...
            RavenV.blinkManager.setBlinkState(false, BlinkModules.AUTO_BLOCK);
            RavenV.blinkManager.setBlinkState(true, BlinkModules.AUTO_BLOCK);
        }
                    ...
                    switch (this.autoBlock.getValue()) {
                        case 0:
                            if (PlayerUtil.isUsingItem()) {
                                ...
                                if (!this.isPlayerBlocking() && !RavenV.playerStateManager.digging && !RavenV.playerStateManager.placing) {
                                    swap = true;
                                }
                            } else {
                                this.isBlocking = false;
                        ...
                        case 2:
                            if (this.hasValidTarget()) {
                                ...
                                if (RavenV.playerStateManager.digging
                                        || RavenV.playerStateManager.placing
                        ...
                        case 5:
                            if (this.hasValidTarget()) {
                                int item = ((IAccessorPlayerControllerMP) mc.playerController).getCurrentPlayerItem();
                                if (mc.thePlayer.inventory.currentItem == item && !RavenV.playerStateManager.digging && !RavenV.playerStateManager.placing) {
                                    switch (this.blockTick) {
                                        case 0:
                                            if (!this.isPlayerBlocking()) {
                                                swap = true;
                        ...
                        case 8:
                            ...
                            if (PlayerUtil.isUsingItem()
                                    ...
                                    && !RavenV.playerStateManager.digging
                                    && !RavenV.playerStateManager.placing) {
                                swap = true;
                            }
                    }
                ...
                if (this.isBoxInSwingRange(this.target.getBox())) {
                    if (this.rotations.getValue() == 2 || this.rotations.getValue() == 3) {
                        ...
                        if (this.rotations.getValue() == 3) {
                            RavenV.rotationManager.setRotation(rotations[0], rotations[1], 1, true);
                        }
            ...
            if (this.showTarget.getValue() != 0
                ...
                switch (this.showTarget.getValue()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        color = ((HUD) RavenV.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis());
                }
