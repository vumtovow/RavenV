...
import ravenv.events.ResizeEvent;
import ravenv.mixin.IAccessorEntityRenderer;
...
import ravenv.util.shader.GlowShader;
import ravenv.util.shader.OutlineShader;
    ...
    private Color getEntityColor(EntityPlayer entityPlayer) {
        if (TeamUtil.isFriend(entityPlayer)) {
            ...
            switch (this.color.getValue()) {
                ...
                case 2:
                    int hudColor = ((HUD) RavenV.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
