...
import ravenv.mixin.IAccessorC0DPacketCloseWindow;
import ravenv.module.Module;
import ravenv.util.KeyBindUtil;
import ravenv.util.PacketUtil;
...
public class InvWalk extends Module {
    ...
    public void pressMovementKeys() {
        ...
        if (RavenV.moduleManager.modules.get(Sprint.class).isEnabled()) {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof ravenv.ui.ClickGui && this.guiEnabled.getValue()) {
            pressMovementKeys();
            return;
        }
