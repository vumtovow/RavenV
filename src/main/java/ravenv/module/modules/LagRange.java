...
import ravenv.util.RotationUtil;
                ...
                case PRE:
                    ...
                    if ((!bedNuker.isEnabled() || !bedNuker.isReady())
                        ...
                        if (players.isEmpty()) {
                            ...
                            Vec3 eyePosition = RavenV.lagManager.getLastPosition().addVector(0.0, height, 0.0);
                            ...
                            for (EntityPlayer player : players) {
                                ...
                                if (!(distance > (double) this.range.getValue())) {
                                    ...
                                    if (distance < targetDist || distance < eyeDist) {
                                        ...
                                        RavenV.lagManager.setDelay(this.tickIndex);
                                        this.hasTarget = true;
                                        return;
                                    }
                                }
                    ...
                    break;
                case POST:
                    Vec3 savedPosition = RavenV.lagManager.getLastPosition();
